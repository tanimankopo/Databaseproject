...
<head>
    ...
    <link rel="stylesheet" href="css/sidebar.css"> <!-- Link to the CSS file -->
</head>
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            <li><a href="cashier-dashboard.php" <?php if(basename($_SERVER['PHP_SELF']) == 'cashier-dashboard.php') echo 'class="active"'; ?>>🏠 Dashboard</a></li>
