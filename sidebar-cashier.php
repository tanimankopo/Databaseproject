...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="cashier-items.php" <?php if(basename($_SERVER['PHP_SELF']) == 'cashier-items.php') echo 'class="active"'; ?>>📦 Available Items</a></li>
            ...
            <li><a href="cashier-receipts.php" <?php if(basename($_SERVER['PHP_SELF']) == 'cashier-receipts.php') echo 'class="active"'; ?>>🧾 Receipts</a></li>
        </ul>
